...
def generate_banner(
    ...
    headline_text: str,
    subtext: str,
    badge_color: tuple = (225, 6, 0), # F1 Crimson
):
    CANVAS_WIDTH = 1080
    CANVAS_HEIGHT = 2400
    
    # 1. Base Canvas with smooth dark obsidian gradient
    base = Image.new('RGBA', (CANVAS_WIDTH, CANVAS_HEIGHT), (10, 12, 16, 255))
    draw = ImageDraw.Draw(base)
    
    for y in range(CANVAS_HEIGHT):
        ratio = y / CANVAS_HEIGHT
        r = int(14 * (1 - ratio) + 6 * ratio)
        g = int(17 * (1 - ratio) + 8 * ratio)
        b = int(24 * (1 - ratio) + 12 * ratio)
        draw.line([(0, y), (CANVAS_WIDTH, y)], fill=(r, g, b, 255))
    
    # 2. Ambient top glow matching badge accent
    glow = Image.new('RGBA', (CANVAS_WIDTH, CANVAS_HEIGHT), (0, 0, 0, 0))
    glow_draw = ImageDraw.Draw(glow)
    glow_draw.ellipse(
        [(CANVAS_WIDTH // 2 - 400, -90), (CANVAS_WIDTH // 2 + 400, 520)],
    ...
    # Draw badge pill on separate RGBA layer
...
def main():
    ...
    slides = [
        {
            "raw": "screenshots/raw/01_telemetry_tower.png",
            "out": "screenshots/store_listing/01_telemetry_banner.png",
            "badge": "PIT WALL LIVE",
            "title": "Real-Time Sector Deltas",
            "sub": "Sector speeds, live intervals & tyre age tracking",
            "color": (225, 6, 0) # F1 Red
        },
        {
            "raw": "screenshots/raw/02_circuit_radar.png",
            "out": "screenshots/store_listing/02_circuit_banner.png",
            "badge": "HISTORIC REPLAY",
            "title": "Live Circuit GPS Radar",
            "sub": "Track driver positions & overtakes in real-time",
            "color": (6, 182, 212) # Cyan
        },
        {
            "raw": "screenshots/raw/03_calendar.png",
            "out": "screenshots/store_listing/03_calendar_banner.png",
            "badge": "2026 CALENDAR",
            "title": "Race Calendar & Times",
            "sub": "Auto-converted local timezones & live countdowns",
            "color": (16, 185, 129) # Emerald Green
        },
        {
            "raw": "screenshots/raw/04_circuit_specs.png",
        ...
        {
            "raw": "screenshots/raw/05_standings.png",
            "out": "screenshots/store_listing/05_standings_banner.png",
            "badge": "WORLD STANDINGS",
            "title": "Championship Standings",
            "sub": "Constructor rankings, points & car specifications",
            "color": (245, 158, 11) # Gold / Amber
        }
    ]
    ...
    print("\n[SUCCESS] All 5 Google Play Store banners generated in screenshots/store_listing/")
